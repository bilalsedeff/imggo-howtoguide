"""
Simple KYC Verification Test
Test the pattern with a sample ID document
"""
...
def main():
    print("="*60)
    print("TESTING KYC VERIFICATION PATTERN")
    print("="*60)
    ...
    try:
        ...
        # JSON format output
        output_file = outputs_dir / "kyc_output.json"
        try:
            kyc_data = result if isinstance(result, dict) else json.loads(result)
