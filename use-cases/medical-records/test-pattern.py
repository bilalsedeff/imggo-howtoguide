"""
Simple Medical Records Test
Test the pattern with a sample medical document
"""
...
def main():
    print("="*60)
    print("TESTING MEDICAL RECORDS PATTERN")
    print("="*60)
    ...
    try:
        ...
        # JSON format output
        output_file = outputs_dir / "medical_record_output.json"
        try:
            medical_data = result if isinstance(result, dict) else json.loads(result)
