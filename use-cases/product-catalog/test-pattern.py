...
def main():
    print("="*60)
    print("TESTING PRODUCT CATALOG PATTERN")
    print("="*60)
    ...
    try:
        ...
        # CSV format output
        output_file = outputs_dir / "product_catalog_output.csv"
