...
Test the pattern with a sample property image
"""
...
def main():
    ...
    # Use city buildings image as property photo
    test_image = Path(__file__).parent.parent.parent / "examples" / "test-images" / "city-buildings1.jpg"
    ...
    try:
        client = ImgGoClient()
        print("Processing property image...")
        ...
        # YAML format output
        output_file = outputs_dir / "real_estate_output.yaml"
